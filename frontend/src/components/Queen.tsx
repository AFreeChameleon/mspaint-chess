...
class Queen extends React.Component<QueenProps, QueenState> {
    mouseUpCompleted: boolean = false;
    constructor(props: QueenProps) {
        super(props);
    ...
    render() {
        ...
        return (
            <div 
                draggable="false"
                id={`queen_${colourName}_${square}`}
                style={isDragging ? { 
                    backgroundImage: `url(/img/queen_${colourName}.png)`, 
                    position: 'absolute',
                    top: position.y + 'px', 
                    left: position.x + 'px',
                    pointerEvents: 'none'
